...
from .types import (DBMSType, MetricType, VarType, HardwareType, TaskType,
                    KnobUnitType, PipelineTaskType)
...
class PipelineResult(models.Model):
    ...
    def get_latest(dbms, hardware, task_type):
        return PipelineResult.objects.filter(dbms=dbms,
                                             hardware=hardware,
                                             task_type=task_type).latest()
